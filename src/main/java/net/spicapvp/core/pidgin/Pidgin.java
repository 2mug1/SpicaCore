package net.spicapvp.core.pidgin;
...
import net.spicapvp.core.pidgin.packet.handler.PacketExceptionHandler;
import net.spicapvp.core.pidgin.packet.listener.PacketListener;
import net.spicapvp.core.pidgin.packet.listener.PacketListenerData;
        ...
        try {
            ...
            try (Jedis jedis = this.jedisPool.getResource()) {
                ...
                try {
                    ...
                    if (SpicaCore.get().getMainConfig().getBoolean("REDIS.AUTHENTICATION.ENABLED")) {
                        jedis.auth(SpicaCore.get().getMainConfig().getString("REDIS.AUTHENTICATION.PASSWORD"));
                    }
