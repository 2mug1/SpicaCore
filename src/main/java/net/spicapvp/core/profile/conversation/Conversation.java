package net.spicapvp.core.profile.conversation;
...
public class Conversation {
	...
	public void sendMessage(Player sender, Player target, String message) {
		sender.sendMessage(Locale.CONVERSATION_SEND_MESSAGE.format(
				sender.getName(), sender.getDisplayName(), SpicaAPI.getColorOfPlayer(sender),
				target.getName(), target.getDisplayName(), SpicaAPI.getColorOfPlayer(target))
				.replace("%MSG%", message));
