...
public class Clan {
    ...
    private void load() {
        Document document = SpicaCore.get().getMongo().getClans().find(Filters.eq("name", name)).first();
    ...
    public void save(){
        ...
        SpicaCore.get().getMongo().getClans().replaceOne(Filters.eq("name", name), document, new ReplaceOptions().upsert(true));
    }
    ...
    public void broadcast(String message){
        SpicaCore.get().getPidgin().sendPacket(new PacketClanBroadcast(this, message));
    }

    public void chat(String message, ClanPlayer sender){
        SpicaCore.get().getPidgin().sendPacket(new PacketClanChat(this, sender, message, SpicaCore.get().getMainConfig().getString("SERVER_NAME")));
    }
    ...
    public static Clan getByName(String clanName){
        Document document = SpicaCore.get().getMongo().getClans().find(Filters.eq("name", clanName)).first();
